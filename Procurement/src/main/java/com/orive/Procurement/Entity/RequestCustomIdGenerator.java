...
public class RequestCustomIdGenerator implements IdentifierGenerator {

	
	private static final long serialVersionUID = 1L;

	private final String prefix = "ORIRQET-";
	...
	public Serializable generate(SharedSessionContractImplementor session, Object object) {
		...
		try {
			...
			String query = "SELECT MAX(request_id), COUNT(request_id) FROM request";
