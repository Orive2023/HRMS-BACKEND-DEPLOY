...
public class CommitteeListCustomIdGenerator implements IdentifierGenerator {
	
	private static final long serialVersionUID = 1L;

	private final String prefix = "ORIBDANLSCMTL-";
	...
	public Serializable generate(SharedSessionContractImplementor session, Object object) {
		...
		try {
			...
			String query = "SELECT MAX(committee_list_id), COUNT(committee_list_id) FROM committeelist";
