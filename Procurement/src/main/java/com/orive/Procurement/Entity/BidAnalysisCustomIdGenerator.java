...
public class BidAnalysisCustomIdGenerator implements IdentifierGenerator {
	
	private static final long serialVersionUID = 1L;

	private final String prefix = "ORIBDANLS-";
	...
	public Serializable generate(SharedSessionContractImplementor session, Object object) {
		...
		try {
			...
			String query = "SELECT MAX(bid_analysis_id), COUNT(bid_analysis_id) FROM bidanalysis";
