...
public class DescriptionOfMaterialListCustomIdGenerator implements IdentifierGenerator {

	
	private static final long serialVersionUID = 1L;

	private final String prefix = "ORIRQETDOML";
	...
	public Serializable generate(SharedSessionContractImplementor session, Object object) {
		...
		try {
			...
			String query = "SELECT MAX(description_of_material_id), COUNT(description_of_material_id) FROM descriptionofmterial";
